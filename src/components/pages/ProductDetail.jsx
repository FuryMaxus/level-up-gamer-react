  ...
  export default function ProductDetail() {
    ...
    if (!currentProduct) return <p>Cargando...</p>;
          ...
          <div id="especifics-details-container">
            <div id="producto-list-specifications">
              ...
              <div id="detail-price-container">
                <h2>{new Intl.NumberFormat('es-CL', {currency: 'CLP', style: 'currency'}).format(currentProduct.price)}</h2>
            
                <Button text='Añadir al Carro' onClick={() => {addToCart(currentProduct)}}/>
